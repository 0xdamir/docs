...
![Cross-Chain Message Diagram](/images/evm-dapp-1.png)
...
![Dapp Diagram](/images/evm-dapp-2.png)
...
A complete list of flags with their description can be found on [EVM smart contract interfaces page](/dev-guides/evm/libraries/flags).
...
pressing the WAGMI button at [https://app.debridge.finance/](https://app.debridge.finance/). Governance may thank you later for being an early
builder.
...
Consider reading the [Lifecycle of a cross-chain](/dev-guides/cross-chain-call-lifecycle) call to get yourself familiar with how the cross-chain calls
are handled.
...
- [Gathering data for the claim](/dev-guides/gathering-data-for-claim)
